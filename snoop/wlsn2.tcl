...
set opt(sc)     "../../mobility/scene/scentest"  ;# node movement file. 
set opt(delay) 1ms
...
lappend eilastlevel 3 4 1            ;# number of nodes in each cluster 
...
#$lan addNode [list $W(1)] 100Mb 1ms LL Queue/DropTail Mac/802_3
...
$ns_ node-config -llType LL/LLSnoop
                        
set BS(0) [$ns_ node [lindex $temp 0]]
$BS(0) random-motion 0               ;# disable random motion

#provide some co-ord (fixed) to base station node
$BS(0) set X_ 15.000000
$BS(0) set Y_ 20.000000
...
$ns_ duplex-link $W(0) $W(1) 500Kb 10ms DropTail
